...
class _AttendanceApiService implements AttendanceApiService {
  ...
  @override
  Future<AttendanceModel> checkIn(Map<String, dynamic> body) async {
  ...
  @override
  Future<AttendanceModel> checkOut(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<AttendanceModel?> getTodayStatus() async {
    ...
    try {
      _value = _result.data == null
          ? null
          : AttendanceModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<List<AttendanceModel>> getHistory() async {
    ...
    try {
      _value = _result.data!
          .map(
            (dynamic i) => AttendanceModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
